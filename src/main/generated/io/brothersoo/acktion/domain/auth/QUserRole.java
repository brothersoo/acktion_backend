...
public class QUserRole extends EntityPathBase<UserRole> {
    ...
    private static final long serialVersionUID = -1948492415L;
    ...
    public final io.brothersoo.acktion.domain.user.QUser user;
    ...
    public QUserRole(Class<? extends UserRole> type, PathMetadata metadata, PathInits inits) {
        ...
        this.user = inits.isInitialized("user") ? new io.brothersoo.acktion.domain.user.QUser(forProperty("user")) : null;
    }
